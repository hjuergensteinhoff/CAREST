...
expName = 'CAREST_v'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\hstei\\Documents\\privat\\Anne\\Annes_Wissenschaft\\Psychopy\\ColdHeatPlate\\CAREST_102\\CAREST_v_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "TareScales" ---
    text_calibrateScales = visual.TextStim(win=win, name='text_calibrateScales',
        text='Wärmeplatte nicht berühren!\n\nWägezellen werden kalibriert.',
        font='Open Sans',
        pos=(0, 0.1), height=0.08, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "ReadScales" ---
    text_calibrateScales_2 = visual.TextStim(win=win, name='text_calibrateScales_2',
        text='Wärmeplatte nicht berühren!\n\nWägezellen werden kalibriert.',
        font='Open Sans',
        pos=(0, 0.1), height=0.08, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
    ...
    text_welcomeScreen = visual.TextStim(win=win, name='text_welcomeScreen',
        text='Willkommen zum Wärmeplattenexperiment\n\nDu kannst nun Deine Hand auf die Wärmeplatte legen.',
        font='Open Sans',
        pos=(0, 0.1), height=0.08, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    slider_weiter = visual.Slider(win=win, name='slider_weiter',
        startValue=1, size=(0.4, 0.1), pos=(-0.4, -0.4), units=win.units,
        labels=['0', 'Weiter'], ticks=(1, 2), granularity=0.0,
        style='choice', styleTweaks=('triangleMarker',), opacity=None,
    ...
    sliderRating_VASex1 = visual.Slider(win=win, name='sliderRating_VASex1',
        ...
        flip=False, ori=0.0, depth=-1, readOnly=False)
    slider_VASex1_weiter = visual.Slider(win=win, name='slider_VASex1_weiter',
        startValue=1, size=(0.25, 0.03), pos=(0.45, 0.45), units=win.units,
        labels=[' ','Weiter'], ticks=(1, 2), granularity=0.0,
    ...
    sliderRating_VASex2 = visual.Slider(win=win, name='sliderRating_VASex2',
        ...
        font='Open Sans', labelHeight=0.03,
        flip=False, ori=0.0, depth=-1, readOnly=False)
    slider_VASex2_weiter = visual.Slider(win=win, name='slider_VASex2_weiter',
        startValue=1, size=(0.25, 0.03), pos=(0.45, 0.45), units=win.units,
        labels=[' ','Weiter'], ticks=(1, 2), granularity=0.0,
        style='choice', styleTweaks=('triangleMarker',), opacity=0.2,
        labelColor='Gray', markerColor='Darkgray', lineColor='White', colorSpace='rgb',
    ...
    sliderRating_VASex3 = visual.Slider(win=win, name='sliderRating_VASex3',
        ...
        font='Open Sans', labelHeight=0.03,
        flip=False, ori=0.0, depth=-1, readOnly=False)
    slider_VASex3_weiter = visual.Slider(win=win, name='slider_VASex3_weiter',
        startValue=1, size=(0.25, 0.03), pos=(0.45, 0.45), units=win.units,
        labels=[' ','Weiter'], ticks=(1, 2), granularity=0.0,
        style='choice', styleTweaks=('triangleMarker',), opacity=0.2,
        labelColor='Gray', markerColor='Darkgray', lineColor='White', colorSpace='rgb',
    ...
    # --- Initialize components for Routine "Hands_off" ---
    text_hands_off = visual.TextStim(win=win, name='text_hands_off',
        text='Bitte die Hand von der Platte nehmen.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Prepare to start Routine "TareScales" ---
    continueRoutine = True
    # update component parameters for each repeat
    # keep track of which components have finished
    TareScalesComponents = [text_calibrateScales]
    for thisComponent in TareScalesComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if text_calibrateScales.status == STARTED:
            ...
            if tThisFlipGlobal > text_calibrateScales.tStartRefresh + 3-frameTolerance:
    ...
    # --- Ending Routine "TareScales" ---
    for thisComponent in TareScalesComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # Run 'End Routine' code from code_tareScales
    # Tare the scales
    if config.serial_port_scales:
       serscales.reset_input_buffer()
       serscales.reset_output_buffer()
    ...
    # --- Prepare to start Routine "ReadScales" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('ReadScales.started', globalClock.getTime(format='float'))
    # keep track of which components have finished
    ReadScalesComponents = [text_calibrateScales_2]
    for thisComponent in ReadScalesComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        # *text_calibrateScales_2* updates
        
        # if text_calibrateScales_2 is starting this frame...
        if text_calibrateScales_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            text_calibrateScales_2.frameNStart = frameN  # exact frame index
            text_calibrateScales_2.tStart = t  # local t and not account for scr refresh
            text_calibrateScales_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_calibrateScales_2, 'tStartRefresh')  # time at next scr refresh
            # update status
            text_calibrateScales_2.status = STARTED
            text_calibrateScales_2.setAutoDraw(True)
        
        # if text_calibrateScales_2 is active this frame...
        if text_calibrateScales_2.status == STARTED:
            # update params
            pass
        
        # if text_calibrateScales_2 is stopping this frame...
        if text_calibrateScales_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_calibrateScales_2.tStartRefresh + 3-frameTolerance:
                # keep track of stop time/frame for later
                text_calibrateScales_2.tStop = t  # not accounting for scr refresh
                text_calibrateScales_2.tStopRefresh = tThisFlipGlobal  # on global time
                text_calibrateScales_2.frameNStop = frameN  # exact frame index
                # update status
                text_calibrateScales_2.status = FINISHED
                text_calibrateScales_2.setAutoDraw(False)
    ...
    # --- Ending Routine "ReadScales" ---
    for thisComponent in ReadScalesComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('ReadScales.stopped', globalClock.getTime(format='float'))
    # Run 'End Routine' code from first_readScales
    # Read the scales for the first time
    if config.serial_port_scales:
       serscales.reset_input_buffer()
       time.sleep(0.1)
       ...
       thisExp.addData('first_contact_force', cleaned_cf_string)
    else:
       thisExp.addData('first_contact_force', None)
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if routineForceEnded:
        routineTimer.reset()
    else:
    ...
    slider_weiter.reset()
    # keep track of which components have finished
    WelcomeScreenComponents = [text_welcomeScreen, slider_weiter]
    ...
    while continueRoutine:
        ...
        # *slider_weiter* updates
        
        # if slider_weiter is starting this frame...
        if slider_weiter.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            slider_weiter.frameNStart = frameN  # exact frame index
            slider_weiter.tStart = t  # local t and not account for scr refresh
            slider_weiter.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(slider_weiter, 'tStartRefresh')  # time at next scr refresh
            # update status
            slider_weiter.status = STARTED
            slider_weiter.setAutoDraw(True)
        
        # if slider_weiter is active this frame...
        if slider_weiter.status == STARTED:
            # update params
            pass
        
        # Check slider_weiter for response to end Routine
        if slider_weiter.getRating() is not None and slider_weiter.status == STARTED:
            continueRoutine = False
    ...
    slider_VASex1_weiter.reset()
    # keep track of which components have finished
    VASexercise1Components = [imageSliderRating_VASex1, sliderRating_VASex1, slider_VASex1_weiter, text_VASex1]
    ...
    while continueRoutine and routineTimer.getTime() < 100.0:
        ...
        # *slider_VASex1_weiter* updates
        
        # if slider_VASex1_weiter is starting this frame...
        if slider_VASex1_weiter.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            slider_VASex1_weiter.frameNStart = frameN  # exact frame index
            slider_VASex1_weiter.tStart = t  # local t and not account for scr refresh
            slider_VASex1_weiter.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(slider_VASex1_weiter, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'slider_VASex1_weiter.started')
            # update status
            slider_VASex1_weiter.status = STARTED
            slider_VASex1_weiter.setAutoDraw(True)
        
        # if slider_VASex1_weiter is active this frame...
        if slider_VASex1_weiter.status == STARTED:
            # update params
            pass
        
        # if slider_VASex1_weiter is stopping this frame...
        if slider_VASex1_weiter.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 100-frameTolerance:
                # keep track of stop time/frame for later
                slider_VASex1_weiter.tStop = t  # not accounting for scr refresh
                slider_VASex1_weiter.tStopRefresh = tThisFlipGlobal  # on global time
                slider_VASex1_weiter.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'slider_VASex1_weiter.stopped')
                # update status
                slider_VASex1_weiter.status = FINISHED
                slider_VASex1_weiter.setAutoDraw(False)
        
        # Check slider_VASex1_weiter for response to end Routine
        if slider_VASex1_weiter.getRating() is not None and slider_VASex1_weiter.status == STARTED:
            continueRoutine = False
    ...
    slider_VASex2_weiter.reset()
    # keep track of which components have finished
    VASexercise2Components = [imageSliderRating_VASex2, sliderRating_VASex2, slider_VASex2_weiter, text_VASex2]
    ...
    while continueRoutine and routineTimer.getTime() < 30.0:
        ...
        # *slider_VASex2_weiter* updates
        
        # if slider_VASex2_weiter is starting this frame...
        if slider_VASex2_weiter.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            slider_VASex2_weiter.frameNStart = frameN  # exact frame index
            slider_VASex2_weiter.tStart = t  # local t and not account for scr refresh
            slider_VASex2_weiter.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(slider_VASex2_weiter, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'slider_VASex2_weiter.started')
            # update status
            slider_VASex2_weiter.status = STARTED
            slider_VASex2_weiter.setAutoDraw(True)
        
        # if slider_VASex2_weiter is active this frame...
        if slider_VASex2_weiter.status == STARTED:
            # update params
            pass
        
        # if slider_VASex2_weiter is stopping this frame...
        if slider_VASex2_weiter.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30-frameTolerance:
                # keep track of stop time/frame for later
                slider_VASex2_weiter.tStop = t  # not accounting for scr refresh
                slider_VASex2_weiter.tStopRefresh = tThisFlipGlobal  # on global time
                slider_VASex2_weiter.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'slider_VASex2_weiter.stopped')
                # update status
                slider_VASex2_weiter.status = FINISHED
                slider_VASex2_weiter.setAutoDraw(False)
        
        # Check slider_VASex2_weiter for response to end Routine
        if slider_VASex2_weiter.getRating() is not None and slider_VASex2_weiter.status == STARTED:
            continueRoutine = False
    ...
    slider_VASex3_weiter.reset()
    # keep track of which components have finished
    VASexercise3Components = [imageSliderRating_VASex3, sliderRating_VASex3, slider_VASex3_weiter, text_VASex3]
    ...
    while continueRoutine and routineTimer.getTime() < 30.0:
        ...
        # *slider_VASex3_weiter* updates
        
        # if slider_VASex3_weiter is starting this frame...
        if slider_VASex3_weiter.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            slider_VASex3_weiter.frameNStart = frameN  # exact frame index
            slider_VASex3_weiter.tStart = t  # local t and not account for scr refresh
            slider_VASex3_weiter.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(slider_VASex3_weiter, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'slider_VASex3_weiter.started')
            # update status
            slider_VASex3_weiter.status = STARTED
            slider_VASex3_weiter.setAutoDraw(True)
        
        # if slider_VASex3_weiter is active this frame...
        if slider_VASex3_weiter.status == STARTED:
            # update params
            pass
        
        # if slider_VASex3_weiter is stopping this frame...
        if slider_VASex3_weiter.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30-frameTolerance:
                # keep track of stop time/frame for later
                slider_VASex3_weiter.tStop = t  # not accounting for scr refresh
                slider_VASex3_weiter.tStopRefresh = tThisFlipGlobal  # on global time
                slider_VASex3_weiter.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'slider_VASex3_weiter.stopped')
                # update status
                slider_VASex3_weiter.status = FINISHED
                slider_VASex3_weiter.setAutoDraw(False)
        
        # Check slider_VASex3_weiter for response to end Routine
        if slider_VASex3_weiter.getRating() is not None and slider_VASex3_weiter.status == STARTED:
            continueRoutine = False
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('Hands_off.started', globalClock.getTime(format='float'))
    # keep track of which components have finished
    Hands_offComponents = [text_hands_off]
    for thisComponent in Hands_offComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    while continueRoutine and routineTimer.getTime() < 10.0:
        ...
        # *text_hands_off* updates
        
        # if text_hands_off is starting this frame...
        if text_hands_off.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            text_hands_off.frameNStart = frameN  # exact frame index
            text_hands_off.tStart = t  # local t and not account for scr refresh
            text_hands_off.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_hands_off, 'tStartRefresh')  # time at next scr refresh
            # update status
            text_hands_off.status = STARTED
            text_hands_off.setAutoDraw(True)
        
        # if text_hands_off is active this frame...
        if text_hands_off.status == STARTED:
            # update params
            pass
        
        # if text_hands_off is stopping this frame...
        if text_hands_off.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_hands_off.tStartRefresh + 10.0-frameTolerance:
                # keep track of stop time/frame for later
                text_hands_off.tStop = t  # not accounting for scr refresh
                text_hands_off.tStopRefresh = tThisFlipGlobal  # on global time
                text_hands_off.frameNStop = frameN  # exact frame index
                # update status
                text_hands_off.status = FINISHED
                text_hands_off.setAutoDraw(False)
    ...
    # --- Ending Routine "Hands_off" ---
    for thisComponent in Hands_offComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('Hands_off.stopped', globalClock.getTime(format='float'))
    # Run 'End Routine' code from last_readScales
    # Read the scales for the last time
    if config.serial_port_scales:
       serscales.reset_input_buffer()
       time.sleep(0.1)
       serscales.write(Scale_read_byte)
       ...
       decoded_cf_string = cf_bytes_read.decode('latin-1')
       cleaned_cf_string = decoded_cf_string.strip()
       thisExp.addData('last_contact_force', cleaned_cf_string)
    else:
       thisExp.addData('last_contact_force', None)
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if routineForceEnded:
        routineTimer.reset()
    else:
    ...
    while continueRoutine and routineTimer.getTime() < 10.0:
        ...
        if text_Goodbye.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_Goodbye.tStartRefresh + 10.0-frameTolerance:
                # keep track of stop time/frame for later
